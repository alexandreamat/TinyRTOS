...
#define GPIO_PORT(pin) GPIO_REG(PORTB, pin, 3)
#define GPIO_DDR(pin) GPIO_REG(DDRB, pin, 3)
#define GPIO_PIN(pin) GPIO_REG(PINB, pin, 3)
#define GPIO_PCMSK(pin) GPIO_REG(PCMSK0, pin, 1)
